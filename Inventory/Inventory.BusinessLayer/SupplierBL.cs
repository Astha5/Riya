...
namespace Inventory.BusinessLayer
{
    public class SupplierBL
    {
        ...
        public static Supplier SearchSuppliertBL(int searchGuestID)
        {
            Supplier searchSupplier = null;
            try
            {
                SupplierDAL guestDAL = new SupplierDAL();
                searchSupplier = guestDAL.SearchSupplierDAL(searchGuestID);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static bool UpdateSupplierBL(Supplier updateSupplier)
        {
            ...
            try
            {
                ...
                {
                    SupplierDAL guestDAL = new SupplierDAL();
                    SupplierUpdated = guestDAL.UpdateSupplierDAL(updateSupplier);
                }
            }
            catch (Exception)
            {
